...
\t";
            // line 86
            if ($this->env->getLoader()->exists('@nickvergessen_newspage/event/acp_main_notice_after.html')) {
                $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
                $this->env->setNamespaceLookUpOrder(array('nickvergessen_newspage', '__main__'));
                $this->env->loadTemplate('@nickvergessen_newspage/event/acp_main_notice_after.html')->display($context);
                $this->env->setNamespaceLookUpOrder($previous_look_up_order);
            }

            if ($this->env->getLoader()->exists('@sarafan_guru/event/acp_main_notice_after.html')) {
                $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
                $this->env->setNamespaceLookUpOrder(array('sarafan_guru', '__main__'));
                $this->env->loadTemplate('@sarafan_guru/event/acp_main_notice_after.html')->display($context);
                $this->env->setNamespaceLookUpOrder($previous_look_up_order);
            }

            if ($this->env->getLoader()->exists('@uloginteam_ulogin/event/acp_main_notice_after.html')) {
                $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
                $this->env->setNamespaceLookUpOrder(array('uloginteam_ulogin', '__main__'));
                $this->env->loadTemplate('@uloginteam_ulogin/event/acp_main_notice_after.html')->display($context);
                $this->env->setNamespaceLookUpOrder($previous_look_up_order);
            }
...
\t\t\t";
                // line 215
                if ($this->env->getLoader()->exists('@nickvergessen_newspage/event/acp_main_actions_append.html')) {
                    $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
                    $this->env->setNamespaceLookUpOrder(array('nickvergessen_newspage', '__main__'));
                    $this->env->loadTemplate('@nickvergessen_newspage/event/acp_main_actions_append.html')->display($context);
                    $this->env->setNamespaceLookUpOrder($previous_look_up_order);
                }

                if ($this->env->getLoader()->exists('@sarafan_guru/event/acp_main_actions_append.html')) {
                    $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
                    $this->env->setNamespaceLookUpOrder(array('sarafan_guru', '__main__'));
                    $this->env->loadTemplate('@sarafan_guru/event/acp_main_actions_append.html')->display($context);
                    $this->env->setNamespaceLookUpOrder($previous_look_up_order);
                }

                if ($this->env->getLoader()->exists('@uloginteam_ulogin/event/acp_main_actions_append.html')) {
                    $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
                    $this->env->setNamespaceLookUpOrder(array('uloginteam_ulogin', '__main__'));
                    $this->env->loadTemplate('@uloginteam_ulogin/event/acp_main_actions_append.html')->display($context);
                    $this->env->setNamespaceLookUpOrder($previous_look_up_order);
                }
...
";
    ...
    {
        return array (  871 => 291,  868 => 290,  864 => 288,  859 => 285,  850 => 282,  847 => 281,  840 => 278,  835 => 277,  831 => 276,  826 => 274,  822 => 273,  818 => 272,  815 => 271,  802 => 270,  798 => 269,  794 => 267,  789 => 266,  782 => 262,  778 => 261,  774 => 260,  770 => 259,  766 => 258,  756 => 253,  751 => 251,  745 => 249,  743 => 248,  740 => 247,  735 => 244,  726 => 241,  722 => 240,  718 => 239,  714 => 238,  711 => 237,  707 => 236,  700 => 232,  696 => 231,  692 => 230,  688 => 229,  678 => 224,  673 => 222,  667 => 220,  665 => 219,  662 => 218,  658 => 216,  636 => 215,  629 => 211,  623 => 210,  618 => 208,  615 => 207,  608 => 203,  602 => 202,  596 => 200,  594 => 199,  587 => 195,  581 => 194,  576 => 192,  569 => 188,  563 => 187,  558 => 185,  551 => 181,  545 => 180,  540 => 178,  533 => 174,  529 => 173,  524 => 171,  517 => 167,  513 => 166,  508 => 164,  503 => 162,  500 => 161,  498 => 160,  492 => 156,  487 => 153,  482 => 151,  476 => 150,  474 => 149,  455 => 147,  449 => 145,  443 => 142,  438 => 141,  434 => 140,  429 => 139,  423 => 136,  418 => 135,  414 => 134,  409 => 133,  403 => 130,  398 => 129,  394 => 128,  389 => 127,  381 => 122,  376 => 121,  372 => 120,  367 => 119,  361 => 116,  356 => 115,  352 => 114,  347 => 113,  341 => 110,  336 => 109,  332 => 108,  327 => 107,  321 => 104,  316 => 103,  312 => 102,  307 => 101,  299 => 96,  295 => 95,  291 => 94,  287 => 93,  280 => 89,  276 => 87,  254 => 86,  251 => 85,  245 => 82,  242 => 81,  240 => 80,  237 => 79,  231 => 76,  228 => 75,  226 => 74,  223 => 73,  220 => 72,  214 => 69,  210 => 68,  207 => 67,  205 => 66,  202 => 65,  196 => 62,  192 => 61,  189 => 60,  187 => 59,  184 => 58,  178 => 55,  174 => 54,  171 => 53,  169 => 52,  166 => 51,  160 => 48,  156 => 47,  153 => 46,  150 => 45,  148 => 44,  145 => 43,  139 => 40,  135 => 39,  132 => 38,  130 => 37,  127 => 36,  121 => 33,  117 => 32,  114 => 31,  112 => 30,  109 => 29,  97 => 26,  93 => 25,  90 => 24,  78 => 21,  74 => 20,  70 => 19,  67 => 18,  65 => 17,  60 => 15,  55 => 13,  52 => 12,  46 => 9,  41 => 7,  38 => 6,  36 => 5,  31 => 2,  19 => 1,);
    }
}
